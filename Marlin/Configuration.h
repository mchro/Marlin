...
#define STRING_CONFIG_H_AUTHOR "(mchro, AluUltimaker)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AluUltimaker"
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  //MCHRO: Autotuned M303 E-1 S55 C5, cheap 12V PCB Mk2 heatbed
  #define  DEFAULT_bedKp 600
  #define  DEFAULT_bedKi 80
  #define  DEFAULT_bedKd 1150
...
#define Z_MAX_POS 188.9-0.6-0.2
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 400, 560 /* MCHRO: calibrated Greg's wade 10/12-2015 */ }  // default steps per unit for Ultimaker
